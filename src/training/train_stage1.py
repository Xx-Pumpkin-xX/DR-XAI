...
class EyePacsDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        label = float(self.df.iloc[idx]['level'])
...
def main():
    ...
    for epoch in range(args.epochs):
        ...
        if val_qwk > best_qwk:
            ...
            print(f"   Saved Model Stage 1 (QWK: {best_qwk:.4f})")
